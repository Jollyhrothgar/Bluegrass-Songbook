{meta: title Arkansas Traveler}
{meta: artist Traditional}
{key: D}
{time: 2/4}
{meta: x_source tunearch}
{meta: x_type instrumental}
{meta: x_tunearch_url https://tunearch.org/wiki/Arkansas_Traveler}
{meta: x_rhythm Country Dance, Reel (single/double)}
{meta: x_genre Bluegrass, Contra, Minstrel, Old-Time, Texas/Oklahoma}
{meta: x_mode Ionian (Major)}
{meta: x_region United States}
{meta: x_structure AB, AABB}
{meta: x_theme_code 126L1 5L5L6L1}
{meta: x_alt_title Banjo Quadrilles: No.5 (The)}
{meta: x_alt_title Engagement Quadrille No. 5 Rackensack Jig}
{meta: x_alt_title Joe Smith}
