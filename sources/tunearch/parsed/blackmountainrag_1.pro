{meta: title Black Mountain Rag}
{meta: artist Traditional}
{key: G}
{time: 4/4}
{meta: x_source tunearch}
{meta: x_type instrumental}
{meta: x_tunearch_url https://tunearch.org/wiki/Black_Mountain_Rag_%281%29}
{meta: x_rhythm Country Rag, Reel (single/double)}
{meta: x_genre Bluegrass, Contest, Old-Time, Texas/Oklahoma}
{meta: x_mode Ionian (Major)}
{meta: x_region United States}
{meta: x_structure AABBCC'}
{meta: x_theme_code 3655 3651}
