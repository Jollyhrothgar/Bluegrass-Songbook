...
def main():
    ...
    parser.add_argument(
        '--output-dir',
        type=str,
        default='sources/classic-country/parsed',
        help='Directory containing .pro files (default: sources/classic-country/parsed)'
    )
    parser.add_argument(
        '--html-dir',
        type=str,
        default='sources/classic-country/raw',
        help='Directory containing .html files (default: sources/classic-country/raw)'
    )
    parser.add_argument(
        '--analysis-dir',
        type=str,
