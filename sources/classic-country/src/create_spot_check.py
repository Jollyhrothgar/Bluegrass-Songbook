...
# Get source root (parent of src directory)
SOURCE_ROOT = Path(__file__).parent.parent

# Load the batch processing results
with open(SOURCE_ROOT / 'batch_processing_report.json', 'r') as f:
    results = json.load(f)
...
output_path = SOURCE_ROOT / 'viewer' / 'stratified_sample_spot_check.json'
