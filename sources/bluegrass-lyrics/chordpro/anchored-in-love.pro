{meta: title Anchored In Love}
{meta: artist Carter Family}
{meta: x_lyrics_source bluegrass-lyrics}
{meta: x_lyrics_url https://www.bluegrasslyrics.com/song/anchored-in-love/}
{meta: x_chords_source traditional-music-uk}
{meta: x_chords_url http://www.traditionalmusic.co.uk/carter-family-songs/Anchored In Love.htm}
...
What gladness what rapture is [E]mine
The [E]danger is past
(The water’s receding, the [E]danger is past)
I’m [D]anchored [A]at [A]last
(I’m feeling so happy I’m [D]anchored [A]at [A]last)
I’m [D]anchored in [A]love divine
{end_of_verse}
