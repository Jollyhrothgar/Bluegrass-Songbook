...
export const MENUS = [
    ...
    },
    {
        ...
        items: [
            ...
            { action: 'finger.ring', label: 'Ring', when: hasNote },
            { action: 'finger.pinky', label: 'Pinky', when: hasNote },
            { separator: true },
            { action: 'finger.lh0', label: 'Left hand 0', when: hasNote },
            { action: 'finger.lh1', label: 'Left hand 1', when: hasNote },
            { action: 'finger.lh2', label: 'Left hand 2', when: hasNote },
            { action: 'finger.lh3', label: 'Left hand 3', when: hasNote },
            { action: 'finger.lh4', label: 'Left hand 4', when: hasNote },
            { separator: true },
            { action: 'finger.clear', label: 'Clear the fingering', when: hasNote },
            { separator: true },
