{meta: title Narrowback (The)}
{meta: artist Traditional}
{key: F}
{time: 4/4}
{meta: x_source tunearch}
{meta: x_type instrumental}
{meta: x_tunearch_url https://tunearch.org/wiki/Narrowback_%28The%29}
{meta: x_rhythm Reel (single/double)}
{meta: x_genre Irish}
{meta: x_mode Ionian (Major)}
{meta: x_region United States}
{meta: x_structure AA'BB'}
{meta: x_theme_code 1H2H1H3H 4H71H5}
{meta: x_alt_title Great North Reel}
{meta: x_alt_title Irish-American Reel (The)}
{meta: x_alt_title Lee's Double Clog}
