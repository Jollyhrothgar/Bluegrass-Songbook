...
Examples:
  ...
  %(prog)s sources/classic-country/parsed/ --recursive  # Count chords in directory recursively
  %(prog)s sources/classic-country/parsed/ --top 10     # Show top 10 most common chords
  %(prog)s sources/classic-country/parsed/ --format json # Output results as JSON
        '''
    )
